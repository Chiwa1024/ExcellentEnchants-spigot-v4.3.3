...
public class Internal_1_21_5 implements EnchantNMS { // Class name updated
    ...
    private static final String REGISTRY_FROZEN_TAGS_FIELD = "j"; // frozenTags (1.21.3)
    private static final String REGISTRY_ALL_TAGS_FIELD    = "k"; // allTags (1.21.3)
    private static final String TAG_SET_UNBOUND_METHOD     = "a"; // .unbound() (1.21.3)
    private static final String TAG_SET_MAP_FIELD          = "val$map"; // (1.21.3)
    private static final String REGISTRY_FROZEN_FIELD      = "l"; // MappedRegistry#frozen (1.21.3)
    private static final String REGISTRY_UNREGISTERED_HOLDERS_FIELD = "m"; // MappedRegistry#unregisteredIntrusiveHolders (1.21.3)
    ...
    public Internal_1_21_5(@NotNull NightPlugin plugin) { // Constructor name updated
        this.plugin = plugin;
    }
    ...
    private static <T> void unfreeze(@NotNull MappedRegistry<T> registry) {
        Reflex.setFieldValue(registry, REGISTRY_FROZEN_FIELD, false);             // MappedRegistry#frozen
        Reflex.setFieldValue(registry, REGISTRY_UNREGISTERED_HOLDERS_FIELD, new IdentityHashMap<>()); // MappedRegistry#unregisteredIntrusiveHolders
    }
