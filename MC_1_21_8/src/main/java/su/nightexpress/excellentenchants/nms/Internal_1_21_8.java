...
public class Internal_1_21_8 implements EnchantNMS {
    ...
    public Internal_1_21_8(@NotNull NightPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    private static <T> void freeze(@NotNull MappedRegistry<T> registry) {
        ...
        // Update inner tags map of the TagSet object that's the 'allTags' field of the registry.
